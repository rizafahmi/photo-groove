...
var _user$project$PhotoGroove$Model = F4(
	function (a, b, c, d) {
		return {photos: a, selectedUrl: b, loadingError: c, choosenSize: d};
	});
								...
								_elm_lang$html$Html$div,
								{
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Attributes$class(
											_user$project$PhotoGroove$sizeToString(model.choosenSize)),
										_1: {ctor: '[]'}
									}
								},
								A2(
